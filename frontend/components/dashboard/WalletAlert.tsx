...
export function WalletAlert() {
  return (
    <div className="flex flex-col gap-2 border border-brick/40 bg-brick/10 p-4 sm:flex-row sm:items-center sm:justify-between">
      ...
      <span className="shrink-0 self-start rounded-full border border-brick/50 px-3 py-1 text-xs font-medium text-brick sm:self-center">
        Próximamente: vincular wallet
      </span>
    </div>
  );
}
