...
| FR-019 | Publicar causa on-chain    | As a receptor, I want que mi causa quede registrada en el contrato y enlazada con su registro en la plataforma so that la verificación y las donaciones apunten a la misma causa. | High | Implemented |
